...
object FunctionalProgramming extends App{
  ...
  /*
    Above is equivalent to the much longer below:
  ...
  // equivalent to the nap/flatMap chain above
  ...
  val accessedElement = aSequence.apply(1) // or aSequence(1) === the element at index 1: 2
  ...
  val setHas5 = aSet.contains(5) // false because 5 is not in set
  ...
  val aPhonebook: Map[String, Int] = Map(
    ("Daniel", 6437812),
    "Jane" -> 327285 // equivalent to above entry
  )
